...
class Nav2QCarConverter : public rclcpp::Node
{
    ...
    command_publisher_  = this->create_publisher<qcar2_interfaces::msg::MotorCommands>("qcar2_motor_speed_cmd/nav2", 10);
    ...
    timer_ = this->create_wall_timer(33ms, std::bind(&Nav2QCarConverter::command_publish, this));
