...
def generate_launch_description():
    ...
    PythonLaunchDescriptionSource([
        os.path.join(get_package_share_directory('qcar2_nodes'), 'launch', 'qcar2_virtual_launch.py')
    ])
    )
    ...
    'yaml_filename',
    description='Full path to map yaml file to load (used internally)',
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(qcar2_dir, 'config', 'qcar2_nav_virtual.yaml'),
    ...
    #     package='qcar2_nodes',
    #     executable='qcar2_odometry_broadcaster',
    #     name='qcar2_odometry_broadcaster',
    #     output='screen'
    # )
    ...
    ld.add_action(qcar2_to_lidar_tf_node)

    ld.add_action(qcar2_launch)

    # ld.add_action(odom_broadcaster)
